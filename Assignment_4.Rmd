...
my_logical2 <- my_logical[2]
my_letters2 <- my_letters[2]

my_list2 <- list(my_matrix2, my_logical2, my_letters2)
print(my_list2)
str(my_list2)

a_vec <- c(my_matrix2, my_logical2, my_letters2)
typeof(a_vec)
```
...
my_letters3 <- sample(LETTERS[1:26])
dFrame2 <- data.frame(my_unifs, my_letters3)
```
